...
--Consulta 11--
(
SELECT extract(YEAR FROM ES.FECHA_EVALUACION) AÑO, extract(MONTH FROM ES.FECHA_EVALUACION) MES,
       P.NOMBRE, P.APELLIDO, count(*) TRATAMIENTOS
FROM PACIENTE P
inner join PACIENTE_TRATAMIENTO PT on PT.ID_PACIENTE = P.ID_PACIENTE
inner join EVALUACION E on E.id_paciente = P.ID_PACIENTE
inner join EVALUACION_SINTOMA ES on ES.ID_EVALUACION = E.ID_EVALUACION
group by P.NOMBRE, P.APELLIDO, ES.FECHA_EVALUACION
order by count(*) DESC
