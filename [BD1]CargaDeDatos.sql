...
INSERT INTO TRATAMIENTO(NOMBRE_TRATAMIENTO, FECHA_TRATAMIENTO)
SELECT DISTINCT TRATAMIENTO_APLICADO, FECHA_TRATAMIENTO
FROM TEMPORAL
...
SELECT DISTINCT P.ID_PACIENTE, T.ID_TRATAMIENTO
FROM TEMPORAL
...
INSERT INTO DIAGNOSTICO(RANGO, NOMBRE_DIAGNOSTICO)
SELECT DISTINCT RANGO_DEL_DIAGNOSTICO, DIAGNOSTICO_DEL_SINTOMA
FROM TEMPORAL
...
INSERT INTO SINTOMA_DIAGNOSTICO(ID_SINTOMA, ID_DIAGNOSTICO)
SELECT DISTINCT S.ID_SINTOMA, D.ID_DIAGNOSTICO
FROM TEMPORAL TT
